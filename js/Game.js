class Game {
  ...
  start() {
    ...
    this.addSprites(obstacles, obstaclesPositions.length, obstacle1Image, 0.2, obstaclesPositions)
...
if(player.fuel<=0){
  ...
  showRank() {
    ...
    swal({
      title: `Awesome!${"\n"}Rank${"\n"}${player.rank}`,
      text: "You reached the finish line successfully", imageUrl: "https://raw.githubusercontent.com/vishalgaddam873/p5-multiplayer-car-race-game/master/assets/cup.png",
      imageSize: "100x100",
  ...
  showLife() {
    push()
    image(heart, width / 2 - 130, height - player.positionY - 400, 50, 50)
    fill("white")
  ...
  showFuel() {
    push()
    image(fuelIMG, width / 2 - 130, height - player.positionY - 100, 50, 50)
    fill("white")
...
gameOver(){
  swal({
    title: `Awesome!${"\n"}Rank${"\n"}${player.rank}`,
    text: "You've ran out of fuel. Game Over", imageUrl: " https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
    imageSize: "100x100",
